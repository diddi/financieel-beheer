...
class Transaction {
    ...
    public static function getMonthlyTotals($userId, $year) {
        $db = Database::getInstance();
        ...
        return $db->fetchAll($sql, [$userId, $year]);
    }
    
    public static function getTotalsByCategory($userId, $type, $startDate, $endDate) {
        $db = Database::getInstance();
        ...
        return $db->fetchAll($sql, [$userId, $type, $startDate, $endDate]);
    }
}